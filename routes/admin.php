...
Route::middleware('verify.admin')->prefix('/admin')->group(
    function () {
        // Home
        ...
        Route::prefix('/doctors')->group(function () {
            Route::get('/appointments/all', [AppointmentController::class, 'showDoctors'])->name('doctors.appointments.all');
            Route::get('/{doctor}/appointments', [AppointmentController::class, 'show'])->name('doctors.appointments.show');
        });
